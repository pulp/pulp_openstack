...
DIRS = ('/var/lib/pulp/published/openstack/web',)
...
LINKS = (
    ('plugins/etc/httpd/conf.d/pulp_openstack.conf', '/etc/httpd/conf.d/pulp_openstack.conf'),
    ('plugins/etc/pulp/server/plugins.conf.d/openstack_distributor.json',
     '/etc/pulp/server/plugins.conf.d/openstack_distributor.json'),
    ('plugins/types/openstack.json', DIR_PLUGINS + '/types/openstack.json'),
)
...
def parse_cmdline():
    ...
    :return: tuple with options and args
    :rtype: tuple
    """
