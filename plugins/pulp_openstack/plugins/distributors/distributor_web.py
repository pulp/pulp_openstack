...
from pulp_openstack.plugins.distributors.publish_steps import WebPublisher
...
def entry_point():
    ...
    return OpenstackImageWebDistributor, plugin_config


class OpenstackImageWebDistributor(Distributor):
    """
    A class for publishing repos for http/https access.
    ...
    def metadata(cls):
        ...
        * types - List of all content type IDs that may be published using this
        ...
        return {
            ...
            'display_name': _('Openstack Image Web Distributor'),
    ...
    def __init__(self):
        ...
        """
        super(OpenstackImageWebDistributor, self).__init__()
